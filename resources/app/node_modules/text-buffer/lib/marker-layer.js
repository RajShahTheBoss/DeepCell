(function() {
  ...
  module.exports = MarkerLayer = (function() {
    ...
    MarkerLayer.prototype.findMarkers = function(params) {
      var end, i, key, len, markerIds, position, ref, ref1, ref2, ref3, result, start, value;
      markerIds = null;
    ...
    MarkerLayer.prototype.restoreFromSnapshot = function(snapshots) {
      var existingMarkerIds, i, id, j, len, len1, marker, newMarker, snapshot, snapshotIds;
      if (snapshots == null) {
        return;
      }
    ...
    MarkerLayer.prototype.serialize = function() {
      var i, id, len, marker, markersById, ranges, ref;
      ranges = this.index.dump();
      markersById = {};
      ref = Object.keys(this.markersById);
      for (i = 0, len = ref.length; i < len; i++) {
    ...
    MarkerLayer.prototype.destroyMarker = function(marker) {
