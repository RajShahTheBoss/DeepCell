module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c1 = function(text) { return text.join(''); },
        peg$c2 = { type: "any", description: "any character" },
        peg$c3 = function(char) { return char; },
        peg$c4 = "\\",
        ...
        peg$c17 = function(index, content) {
    ...
    function peg$parsebodyContentText() {
      var s0, s1, s2;

      s0 = peg$currPos;
      s1 = [];
      s2 = peg$parsebodyContentChar();
      if (s2 !== peg$FAILED) {
        while (s2 !== peg$FAILED) {
          s1.push(s2);
          s2 = peg$parsebodyContentChar();
    ...
    function peg$parsebodyContentChar() {
      var s0, s1, s2;
    ...
    function peg$parsetabStopWithPlaceholder() {
      ...
      if (s1 !== peg$FAILED) {
        ...
        if (s2 !== peg$FAILED) {
          ...
          if (s3 !== peg$FAILED) {
            s4 = peg$parseplaceholderContent();
            if (s4 !== peg$FAILED) {
              if (input.charCodeAt(peg$currPos) === 125) {
                s5 = peg$c13;
                peg$currPos++;
    ...
    function peg$parseplaceholderContent() {
      var s0, s1, s2;
      ...
      if (s2 === peg$FAILED) {
        ...
        if (s2 === peg$FAILED) {
          s2 = peg$parseplaceholderContentText();
        }
      }
      while (s2 !== peg$FAILED) {
        s1.push(s2);
    ...
    function peg$parseplaceholderContentText() {
      var s0, s1, s2;

      s0 = peg$currPos;
      s1 = [];
      s2 = peg$parseplaceholderContentChar();
      if (s2 !== peg$FAILED) {
        while (s2 !== peg$FAILED) {
          s1.push(s2);
          s2 = peg$parseplaceholderContentChar();
    ...
    function peg$parseplaceholderContentChar() {
      var s0, s1, s2, s3;
    ...
    function peg$parsevariableContent() {
      var s0, s1, s2;
      ...
      s2 = peg$parsevariable();
      if (s2 === peg$FAILED) {
        s2 = peg$parsevariableContentText();
      }
      while (s2 !== peg$FAILED) {
        s1.push(s2);
        s2 = peg$parsevariable();
    ...
    function peg$parsevariableContentText() {
      var s0, s1, s2;

      s0 = peg$currPos;
      s1 = [];
      s2 = peg$parsevariableContentChar();
      if (s2 !== peg$FAILED) {
        while (s2 !== peg$FAILED) {
          s1.push(s2);
          s2 = peg$parsevariableContentChar();
    ...
    function peg$parsevariableContentChar() {
      var s0, s1, s2;
